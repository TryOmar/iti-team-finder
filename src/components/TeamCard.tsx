...
export default function TeamCard({ team }: TeamCardProps) {
  ...
  return (
    <div className={`bg-white rounded-2xl border ${isMyPost ? 'border-red-200 shadow-lg shadow-red-50/50' : 'border-gray-100'} p-6 hover:shadow-xl hover:shadow-emerald-50 transition-all duration-300 relative overflow-hidden group flex flex-col h-full ${team.status === 'closed' ? 'opacity-60 grayscale-[0.6] saturate-50' : ''}`}>
